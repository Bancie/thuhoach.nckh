...
\begin{proof}
	...
	Giả sử ta cần sắp xếp lại vị trí hai công việc này bằng cách tráo đổi vị trí với nhau thì ta nhận được chuỗi công việc $S'$, lúc này phương án là $k - j$. \eqref{jk_edd2}
	...
	Lúc này độ đáo hạn của hai công việc $j$ và $k$ trong chuỗi công việc $S'$ lần lượt là
